...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2025.08.15-dbc8d73-$(date +%s)"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2025.08.15-dbc8d73"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2025.08.15-dbc8d73/cursor-agent ~/.local/bin/cursor-agent
